...
//--------------- 사용자 설정------------------------------------------------------시작
//[이미지삽입]
$image_path				= $_SERVER["DOCUMENT_ROOT"]."/_data/_editor";													//파일 저장 디렉토리의 서버 절대, 또는 상대경로
$image_webpath			= "http://".$_SERVER["SERVER_NAME"].$base_dir."_editor";			//파일 저장 디렉토리의 웹경로
...
//[첨부파일]
$attach_path			= "_editor";													//파일 저장 디렉토리의 서버 절대, 또는 상대경로
