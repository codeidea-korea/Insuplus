...
function myEditor($mode, $editor_Path, $editor_Url,$formName,$contentForm,$textWidth,$textHeight,$lang=''){
	...
	if($mode==1) {
		@include_once ($editor_Path.'/editor.php');
	}
	else{
		ECHO "
		<textarea style='width:".$textWidth.";height:".$textHeight."' name='".$contentForm."' wrap='physical' style='ime-mode: active' class='a_textarea'>".$content."</textarea>
		";
	}
}
