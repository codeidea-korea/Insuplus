<?
if(strlen($lang)) header("Content-Type: text/html; charset=utf-8");
?>
<HTML>
<HEAD>
...
<table border="0" cellpadding="5" cellspacing="2" width="100%">
	...
	<tr>
		<td colspan=2 align="center" style="table-layout:fixed">
		<script language="javascript">
		<!--
			document.writeln('<textarea name="content" wrap="hard" style="width:500px;;height:350;" onkeydown="TapKey(this);" class="input">' + valOutPut() + '</textarea>');
		//-->
		</script>
		</td>
	</tr>
