...
$webnote_uri			= "/_util/webnote";

//파일 업로드 디렉토리 (현재 파일을 기준으로 상대 또는 절대경로)
$upload_path			= $_SERVER["DOCUMENT_ROOT"]."/_data/_editor/";

//업로드 허용 파일 확장자
$allow_file_ext			= array("jpg","gif","png");

//파일 FULL URL
//$upload_url			= "http://".$_SERVER["HTTP_HOST"].$webnote_uri."/upload/";
$upload_url			= "/_data/_editor/";

//year,month,day (year: $image_webpath/2012) , default : day
$dir_type			= "month";

//이미지 업로드 시 가능한 최대 가로사이즈(픽셀) : 초과시 이 사이즈로 리사이징되어 저장됨(0: 제한없음)
$allow_image_max_width		= 900;

// 업로드제한용량(byte) (기본 : 1메가, 0: 무제한 , 서버의 설정에따라 별도의 제한이 걸릴 수 있습니다.)
$allow_image_max_volume		= 1024*1024*2;
