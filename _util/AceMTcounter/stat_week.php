...
$select_ww = array("일요일", "월요일", "화요일", "수요일", "목요일", "금요일", "토요일");

$date1 = date("ymd");
$y1 = substr($date1, 0, 2);
$m1 = substr($date1, 2, 2);
$d1 = substr($date1, 4, 2);
$u1 = $_SERVER['PHP_SELF'] . "?fy=" . $y1 . "&fm=" . $m1 . "&fd=" . $d1 . "&fw=" . $nw;

$date2 = date("ymd", mktime(0,0,0,$m1,$d1-7,$y1));
$y2 = substr($date2, 0, 2);
$m2 = substr($date2, 2, 2);
$d2 = substr($date2, 4, 2);
$u2 = $_SERVER['PHP_SELF'] . "?fy=" . $y2 . "&fm=" . $m2 . "&fd=" . $d2 . "&fw=" . $nw;

$date3 = date("ymd", mktime(0,0,0,$m1,$d1-14,$y1));
$y3 = substr($date3, 0, 2);
$m3 = substr($date3, 2, 2);
$d3 = substr($date3, 4, 2);
$u3 = $_SERVER['PHP_SELF'] . "?fy=" . $y3 . "&fm=" . $m3 . "&fd=" . $d3 . "&fw=" . $nw;

$ul = "fy=" . $_GET['fy'] . "&fm=" . $_GET['fm'] . "&fd=" . $_GET['fd'] . "&fw=" . $_GET['fw'];
    ...
    <td>
        ...
        <tr>
        	<td>
				...
				<select name="fw" onchange="this.form.submit()">
                    <option value="">-요일-</option>
                    <?=selectbox($select_ww, $_GET['fw'], true)?>
                </select>
            </td>
            <td align="center">
            ...
            <td align="right">
                <input type="button" value="이번주" class="button" onclick="location.href='<?=$u1?>'">
                <input type="button" value="1주전" class="button" onclick="location.href='<?=$u2?>'">
                <input type="button" value="2주전" class="button" onclick="location.href='<?=$u3?>'">
            </td>
        </tr>
        </table>
    </td>
...
<tr>
    <td><img src="img_week1-1.php?<?=$ul?>"></td>
</tr>
<tr>
    <td align="center">
        [표1-1]. 주별 방문수 합계
...
<tr>
    <td><img src="img_week1-2.php?<?=$ul?>"></td>
</tr>
<tr>
    <td align="center">
        [표1-2]. 주별 평균 방문수
...
<tr>
    <td><img src="img_week2-1.php?<?=$ul?>"></td>
</tr>
<tr>
    <td align="center">
       [표2-1]. IP당 주별 방문수 합계
...
<tr>
    <td><img src="img_week2-2.php?<?=$ul?>"></td>
</tr>
<tr>
    <td align="center">
        [표2-2]. IP당 주별 평균 방문수
