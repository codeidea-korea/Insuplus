...
<!-- <FORM NAME='tophone' ACTION='./_util/sms/sendresult.php' TARGET="hidden_phone" METHOD=POST onsubmit='return send_check();'> -->

	<INPUT TYPE=HIDDEN NAME='remote_url' VALUE="<?ECHO $remote_url;?>">
	...
	<tr>
		<td align="middle" background="<?ECHO $img_path;?>/image/phone/mob_bg.gif" colSpan="3">
			...
			<input style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; BORDER-LEFT: #999999 1px solid; BORDER-BOTTOM: #999999 1px solid;" maxLength="12" size="10" name="return_phone" value="<?ECHO $sms_admin_num;?>">
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td style="PADDING-TOP: 5px" background="<?ECHO $img_path;?>/image/phone/mob_bg.gif" colSpan="3">
			<span style="FONT-SIZE: 9pt">&nbsp;&nbsp;(예약)
			<input style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; FONT-SIZE: 9pt; BORDER-LEFT: #999999 1px solid; BORDER-BOTTOM: #999999 1px solid; width:40px;" maxLength="2" value="<?ECHO date("Y")?>" name="preengage_year">-<input style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; FONT-SIZE: 9pt; BORDER-LEFT: #999999 1px solid; BORDER-BOTTOM: #999999 1px solid; width:20px;" maxLength="2" size="2" value="<?ECHO date("m")?>" name="preengage_month">-<input style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; FONT-SIZE: 9pt; BORDER-LEFT: #999999 1px solid; BORDER-BOTTOM: #999999 1px solid; width:20px;" maxLength="2" size="2" value="" name="preengage_day"><br>
			<img src="<?ECHO $img_path;?>/image/phone/blank.gif" width=20 height=1>
...
<div id=reciever_numer style='visibility:visible;position:;'>
	<table cellspacing=0 cellpadding=0 width="152" border="0">
		<tr>
			<td align="middle" background="<?ECHO $img_path;?>/image/phone/mob_bg.gif" colSpan="3">
				<p><b><font color="#ff6600">수신</font></b>
				<input style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; BORDER-LEFT: #999999 1px solid; BORDER-BOTTOM: #999999 1px solid; width:40px;" maxLength="8" size="3" name="phone_type">
				- <input style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; BORDER-LEFT: #999999 1px solid; BORDER-BOTTOM: #999999 1px solid; width:50px;" maxLength="8" size="8" name="phone_num"></p>
			</td>
		</tr>
	</table>
</div>

<div id=hreciever_numer style='visibility:hidden;position:absolute;'>
	<table cellspacing=0 cellpadding=0 width="152" border="0">
		<tr>
			<td align="middle" background="<?ECHO $img_path;?>/image/phone/mob_bg.gif" colSpan="3" height="20">
				<p><span style="FONT-SIZE: 9pt"><font color="#ff6600"><b>수신</b>
				: 선택된<input style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; FONT-SIZE: 9pt; BORDER-LEFT: #999999 1px solid; BORDER-BOTTOM: #999999 1px solid" maxLength="2" size="2" value="" name="multi_num">명전송</font> </span>
				<BR><textarea name=num_list1 rows=1 cols=1 style='width:145; height:100;overflow:auto;border:solid 1 c0c0c0;' readonly></textarea>
				</p>
			</td>
		</tr>
	</table>
...
<table cellspacing=0 cellpadding=0 border="0">
	...
	<textarea name=num_list rows=1 cols=1 style='position:absolute;visibility:hidden;'></textarea>
	<textarea name=send_id rows=5 cols=20 style='position:absolute;visibility:hidden;'></textarea>
	<input type=hidden name=toname value="">
	<input type=hidden name= remote_etc1 value='<?=$member[id]?>'>
	</FORM>
