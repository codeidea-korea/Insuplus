...
<FORM NAME='tophone' ACTION='http://www.cmscafe.com/libs/sms_message_action.html' TARGET="hidden_phone" METHOD=POST onsubmit='return send_check();'>
<!--
<FORM NAME='tophone' ACTION='../module/sms/sendresult.php' TARGET="hidden_phone" METHOD=POST onsubmit='return send_check();'>
-->

<INPUT TYPE=HIDDEN NAME='remote_url' VALUE="http://haewuso.co.kr/admin/module/sms/sendresult.php">
  ...
  <tbody>
    ...
    <tr>
      <td style="PADDING-TOP: 5px" background="<?ECHO $img_path;?>/image/phone/mob_bg.gif" colSpan="3"><span style="FONT-SIZE: 9pt">&nbsp;&nbsp;(예약)
         <input style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; FONT-SIZE: 9pt; BORDER-LEFT: #999999 1px solid; BORDER-BOTTOM: #999999 1px solid" maxLength="2" size="4" value="<?ECHO date("Y")?>" name="preengage_year">-<input style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; FONT-SIZE: 9pt; BORDER-LEFT: #999999 1px solid; BORDER-BOTTOM: #999999 1px solid" maxLength="2" size="2" value="<?ECHO date("m")?>" name="preengage_month">-<input style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; FONT-SIZE: 9pt; BORDER-LEFT: #999999 1px solid; BORDER-BOTTOM: #999999 1px solid" maxLength="2" size="2" value="" name="preengage_day"><br>
		<img src="<?ECHO $img_path;?>/image/phone/blank.gif" width=58 height=1>
...
<table cellspacing=0 cellpadding=0 width="152" border="0">
    <tr>
      <td align="middle" background="<?ECHO $img_path;?>/image/phone/mob_bg.gif" colSpan="3">
		...
		<input style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; BORDER-LEFT: #999999 1px solid; BORDER-BOTTOM: #999999 1px solid" maxLength="8" size="3" name="phone_type">
	- <input style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; BORDER-LEFT: #999999 1px solid; BORDER-BOTTOM: #999999 1px solid" maxLength="8" size="8" name="phone_num"></p>
      </td>
    </tr>
	</table>
</div>
