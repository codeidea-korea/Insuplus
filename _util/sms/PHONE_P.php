...
-->
<INPUT TYPE=HIDDEN NAME='remote_url' VALUE="haewuso.co.kr/admin/module/sms/sendresult1.php">
...
<INPUT TYPE=HIDDEN NAME='msg_on_off' VALUE='off'>
  <tbody>
    ...
    <tr>
	  ...
	  <input style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; BORDER-LEFT: #999999 1px solid; BORDER-BOTTOM: #999999 1px solid" maxLength="12" size="12" name="return_phone" value="<?ECHO $send_num;?>" readonly></td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="PADDING-TOP: 5px" background="<?ECHO $img_path;?>/image/phone/mob_bg.gif" colSpan="3"><span style="FONT-SIZE: 9pt">&nbsp;&nbsp;(예약)
		...
		<img src="<?ECHO $img_path;?>/image/phone/blank.gif" width=40 height=1>
...
<table cellspacing=0 cellpadding=0 width="152" border="0">
    <tr>
      <td align="middle" background="<?ECHO $img_path;?>/image/phone/mob_bg.gif" colSpan="3">
		...
		<input style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; BORDER-LEFT: #999999 1px solid; BORDER-BOTTOM: #999999 1px solid" maxLength="8" size="3" name="phone_type" readonly>
	- <input style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; BORDER-LEFT: #999999 1px solid; BORDER-BOTTOM: #999999 1px solid" maxLength="8" size="8" name="phone_num" readonly></p>
      </td>
    </tr>
	</table>
</div>
