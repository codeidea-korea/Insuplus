...
<table class="adm-view-tb">
	...
	<tr>
		<th>제휴사</th>
		<td colspan="3"><select title="제휴사 선택" id="recom_partnership_code" class="selectSt01" name="recom_partnership_code">
	...
	<tr>
		<th>사용기간</th>
		<td>
			<input type="text" id="start_date" name="start_date" value="<?=substr($start_date, 0, 10)?>" class="w100 datepicker">
			<span style="padding-left: 5px; padding-right: 5px;">~</span>
			<input type="text" id="end_date" name="end_date" value="<?=substr($end_date, 0, 10)?>" class="w100 datepicker">
		</td>
		<th>할인율</th>
		<td>
