...
$service_fee_max = REQSTR($service_fee_max, null);
$service_fee_fixed = REQSTR($service_fee_fixed, null);
$service_fee_max_discount_amount = (!is_null($service_fee_max) ? $service_fee_max : $service_fee_fixed);
