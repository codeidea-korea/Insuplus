...
<div class="col-md-10 col-sm-9">
						<div class="sub-content cs-wrap">
							<p class='m-b-1'>인슈플러스 보험상품에 대해 문의해주세요.</p>
							<div class='row-border responsive'>
								<div class='detail-col-label'>제목</div>
								<div class='detail-col-input colspan-3 flex-column text-left'><?=$subject?>
								<div class='hidden visible-xs'></div>
								<span class='pull-lg-right pull-md-right pull-sm-right'>조회수 : <?=$view_cnt?>&nbsp;&nbsp;/&nbsp;&nbsp;<?=substr($counsel_date, 0, 10)?></span></div>
								<div class='detail-col-label'>구분</div>
								<div class='detail-col-input'><?=print_pr_name($pr_cd)?></div>
								<div class='detail-col-label'>국가</div>
								<div class='detail-col-input'><?=$nation_arr[$nation]?></div>
								<div class='detail-col-all p-y-3'>
								<? /*
...
<colgroup>
	...
	<tr>
		<th>상담일</th>
		<td><?=substr($counsel_date, 0, 10)?></td>
		<th>조회수</th>
		<td><?=$view_cnt?></td>
	</tr>
	<tr>
		<th>상품명</th>
		<td colspan="3"><?=print_pr_name($pr_cd)?></td>
	</tr>
