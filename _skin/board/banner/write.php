...
<script type="text/javascript">
 $(document).ready(function() {
  ...
  $("#ext1").datepicker(clareCalendar);
  $("#ext2").datepicker(clareCalendar);
  $("#ext4").datepicker(clareCalendar);
  $("#ext5").datepicker(clareCalendar);
...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
	...
	<tr>
		<td class="b_txt_w">이벤트기간</td>
		<td class="m_content">
			<input type="text" id="ext1" name="ext1" value="<?=$ext1?>" class="input"> ~
			<input type="text" id="ext2" name="ext2" value="<?=$ext2?>" class="input">
		</td>
	</tr>
	<tr>
		<td colspan="2" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		<td class="b_txt_w">배너 게시기간</td>
		<td class="m_content">
			<input type="text" id="ext4" name="ext4" value="<?=$ext4?>" class="input"> ~
			<input type="text" id="ext5" name="ext5" value="<?=$ext5?>" class="input">
		</td>
	</tr>
	<tr>
		<td colspan="2" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		...
		<td class="m_content">
			<input type="text" id="ext3" name="ext3" value="<?=$ext3?>" class="input" style="width:80%">
			<select name="ext6">
			<option value="_self" <?if ($ext6=="_self"){?>selected<?}?>>자기창</option>
			<option value="_blank" <?if ($ext6=="_blank"){?>selected<?}?>>새창</option>
			</select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="b_txt_w">순번</td>
		<td class="m_content">
			<input type="text" id="ext10" name="ext10" value="<?=$ext10?>" class="input" style="width:100px;">
			순번이 작을수록 앞에 나옵니다.
		</td>
	</tr>
	<tr>
	...
	<tr>
        ...
        // 신규 파일 등록
			...
			<br/>메인배너 사이즈 : 660 x 470
			<br/>지역배너 사이즈 : 325 x 230
		</td>
	</tr>
	<tr>
		<td colspan="2" class="m_line_1px">&nbsp;</td>
