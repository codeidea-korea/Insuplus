...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr>
		...
		<td width="50"  class="b_txt">번호</td>
		<?if ($bc_category_use == "Y") {?>
		<td width="70" class="b_txt">문의유형</td>
		<?}?>
		<td class="b_txt">제목</td>

		<?if ( $bc_upfile_cnt > 0 ) {?>
		<td width="41" class="b_txt">파일</td>
		<?}?>
		<td width="150" class="b_txt">게시일자</td>
		<td width="70" class="b_txt">작성자</td>
		<td width="70" class="b_txt">작성일</td>
		<td width="50" class="b_txt">조회수</td>
	</tr>
	<tr>
