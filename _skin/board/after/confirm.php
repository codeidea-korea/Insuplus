					...
					<td align="center" bgcolor="fafafa">
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td>
									<? if ($auth_level < $auth_admin) { ?>
										<input name="passwd" type="password" maxlength="20" size="23" />
									<? } ?>
								</td>
								<td>
									<input type="image" src="<?=$url_skin_board.$bc_skin?>/images/b_confirm_ok.gif" width="71" height="23" hspace="3" />
									<a href="javascript:history.back();"><img src="<?=$url_skin_board.$bc_skin?>/images/b_confirm_cancle.gif" hspace="3" border="0" align="absmiddle"/></a>
								</td>
							</tr>
						</table>
						<br />
