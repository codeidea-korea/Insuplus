...
<div id='pop_up_banner' style='display:none;'>
  <span class='button b-close' style='box-shadow:none;font:bold 131% sans-serif;padding:0 6px 2px;position:absolute;right:-20px;top:1px; background-color:#FFFFFF; color:#333333; cursor: pointer; display: inline-block; text-align: center;'><span>X</span></span> <!-- 닫기 버튼 (스타일은 알아서 지정) -->
  <div class='content_js_popup'></div> <!-- 컨텐츠가 들어갈 영역 지정 (이미지, html 등.. 여러가지를 동적으로 부를수 있다. -->
 </div>
<script type='text/javascript' src="https://code.jquery.com/jquery-2.1.4.min.js"></script>
<script type='text/javascript' src='/html/_js/jquery.bpopup.min.js'></script>
