...
<? } ?>
		...
		<tr>
			<td class="b_txt_w"><img src="<?=$url_skin_board.$bc_skin?>/images/b_txt_writer.gif"></td>
			<td class="m_content">
		...
		<? } else { ?>
		<tr>
			<td class="b_txt_w"><img src="<?=$url_skin_board.$bc_skin?>/images/b_txt_pw.gif"></td>
			<td class="m_content">
		...
		<? if ( $bc_email_use != "N") { ?>
		<tr>
			<td class="b_txt_w"><img src="<?=$url_skin_board.$bc_skin?>/images/b_txt_email.gif"></td>
			<td class="m_content">
				<? if ($mode == "mod") { ?>
		...
		<tr>
			<td class="b_txt_w"><img src="<?=$url_skin_board.$bc_skin?>/images/b_txt_homepage.gif"></td>
		...
		<tr>
			<td class="b_txt_w"><img src="<?=$url_skin_board.$bc_skin?>/images/b_txt_title.gif"></td>
			<td class="m_content">
		...
		<tr>
			<td class="b_txt_w"><img src="<?=$url_skin_board.$bc_skin?>/images/b_txt_content.gif"></td>
			<td class="m_content">
			<?
				if ( $bc_editor_use == "Y" ) {
		...
		<tr>
			<td class="b_txt_w">
				<img src="<?=$url_skin_board.$bc_skin?>/images/b_txt_file.gif">
				<? if ( $bc_upfile_cnt > 1) { ?>
				...
				?>
					<tr>
						<td class="m_content">
							...
							현재 등록된 파일 : <?=$FC_file_name?> <?=$FC_file_size?>
