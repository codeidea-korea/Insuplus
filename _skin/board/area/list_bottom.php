...
<!--
function open_excel(){
	window.open("<?=$url_skin_board.$bc_skin?>/excel_upload.php","_p","width=600,height=400");
}
//-->
</script>
			<!-- ### 페이지 시작 ###  -->
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				<tr>
					...
					<td width="170" align="right" valign="top" style="padding:11px 0 0 0">
						<? if ($auth_write) { ?>
							<span class="inp_orange"><input type="button" value="엑셀업로드" onclick="open_excel();"></span>
							<span class="inp_black1"><input type="button" value="글쓰기" onclick="javascript:write_go();"></span>
