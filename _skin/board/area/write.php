...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
	...
	<tr>
		<td colspan="4" class="m_line_2px">&nbsp;</td>
	</tr>
	...
	<tr>
		<td colspan="4" class="m_line_1px">&nbsp;</td>
	</tr>
	<?
    }
	?>
	...
	<tr>
		<td class="b_txt_w">정류소ID</td>
		<td class="m_content">
			<input type="text" name="ext2" value="<?=$ext2?>" style="width:100%" maxlength="150" class="input"/>
		</td>
		<td class="b_txt_w">자치구</td>
		<td class="m_content">
			<input type="text" name="ext3" value="<?=$ext3?>" style="width:100%" maxlength="150" class="input"/>
		</td>
	</tr>
	<tr>
		<td colspan="4" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		<td class="b_txt_w">동명</td>
		<td class="m_content">
			<input type="text" name="ext4" value="<?=$ext4?>" style="width:100%" maxlength="150" class="input"/>
		</td>
		<td class="b_txt_w">정류소명</td>
		<td class="m_content">
			<input type="text" name="ext5" value="<?=$ext5?>" style="width:100%" maxlength="150" class="input"/>
		</td>
	</tr>
	<tr>
		<td colspan="4" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		<td class="b_txt_w">상세주소</td>
		<td class="m_content">
			<input type="text" name="ext6" value="<?=$ext6?>" style="width:100%" maxlength="150" class="input"/>
		</td>
		<td class="b_txt_w">타입</td>
		<td class="m_content">
			<input type="text" name="ext7" value="<?=$ext7?>" style="width:100%" maxlength="150" class="input"/>
		</td>
	</tr>
	<tr>
		<td colspan="4" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		<td class="b_txt_w">등급</td>
		<td class="m_content">
			<input type="text" name="ext8" value="<?=$ext8?>" style="width:100%" maxlength="150" class="input"/>
		</td>
		<td class="b_txt_w">매체코드</td>
		<td class="m_content">
			<input type="text" name="ext9" value="<?=$ext9?>" style="width:100%" maxlength="150" class="input"/>
		</td>
	</tr>
	<tr>
		<td colspan="4" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		<td class="b_txt_w">조명여부</td>
		<td class="m_content">
			<input type="text" name="ext10" value="<?=$ext10?>" style="width:100%" maxlength="150" class="input"/>
		</td>
		<td class="b_txt_w">단가</td>
		<td class="m_content">
			<input type="text" name="ext11" value="<?=$ext11?>" style="width:100%" maxlength="150" class="input"/>
		</td>
	</tr>
	<tr>
		<td colspan="4" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		<td class="b_txt_w">내경</td>
		<td class="m_content">
			<input type="text" name="ext12" value="<?=$ext12?>" style="width:100%" maxlength="150" class="input"/>
		</td>
		<td class="b_txt_w">외경</td>
		<td class="m_content">
			<input type="text" name="ext13" value="<?=$ext13?>" style="width:100%" maxlength="150" class="input"/>
		</td>
	</tr>
	<tr>
		<td colspan="4" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		<td class="b_txt_w">경유노선</td>
		<td class="m_content">
			<input type="text" name="ext14" value="<?=$ext14?>" style="width:100%" maxlength="150" class="input"/>
		</td>
		<td class="b_txt_w">유동인구</td>
		<td class="m_content">
			<input type="text" name="ext15" value="<?=$ext15?>" style="width:100%" maxlength="150" class="input"/>
		</td>
	</tr>
	<tr>
		<td colspan="4" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		<td class="b_txt_w">주변환경</td>
		<td class="m_content">
			<input type="text" name="ext16" value="<?=$ext16?>" style="width:100%" maxlength="150" class="input"/>
		</td>
		<td class="b_txt_w">계약</td>
		<td class="m_content">
			<input type="text" name="ext17" value="<?=$ext17?>" style="width:20%" maxlength="10" class="input"/>~
			<input type="text" name="ext18" value="<?=$ext18?>" style="width:20%" maxlength="10" class="input"/>
		</td>
	</tr>
	<tr>
		<td colspan="4" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		<td class="b_txt_w">좌표</td>
		<td class="m_content" colspan="3">
			<input type="text" name="excode" value="<?=$excode?>" style="width:100%" maxlength="150" class="input"/>
		</td>
	</tr>
	<tr>
		<td colspan="4" class="m_line_1px">&nbsp;</td>
...
<?}?>
<!-- http://apis.daum.net/local/geo/addr2coord?apikey=fffd9296aa4f4a7ea94bf78d3fc603c4&q=<?=urlencode("서울특별시 서초구 서초중앙로")?>&output=xml -->