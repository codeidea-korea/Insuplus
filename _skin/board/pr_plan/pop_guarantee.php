...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		...
		<td valign="top" class="a_st">보장내역 선택</td>
	</tr>
	<tr>
		...
		<td>
			...
			<table width="98%" cellspacing="0" cellpadding="0" border="0" style="margin:0 auto;">
				...
				<tr>
					...
					<td align="center" bgcolor="#F3F3F3" class="a_thead" width="100">보장내역명</td>
					<td align="center" bgcolor="#F3F3F3" class="a_thead">등록일</td>
					<td align="center" bgcolor="#F3F3F3" class="a_thead" width="100">선택</td>
				</tr>
			<? if ($total_record == 0) { ?>
				<tr align="center">
			...
			?>
				<tr>
					<td align="center" class="a_content_td" height="28"><?=$no?><input type="hidden" name="idx[]" value="<?=$seq?>"></td>
					<td align="center" class="a_content_td"><?=$subject?></td>
					<td align="center" class="a_content_td"><?=$regdate?></td>
					<td align="center" class="a_content_td"><em class="inp_black1"><input type="button" value="선택" onclick="g_select(<?=$seq?>,'<?=$subject?>');"></em></td>
				</tr>
				<tr>
					<td colspan="100" height="1" bgcolor="#E5E5E5"></td>
				</tr>
...
<script>
	function g_select(idx,subject){
		...
		ff.ext4.value=idx;
		$("#ext4_txt",opener.document).text(subject);
		window.close();
	}
