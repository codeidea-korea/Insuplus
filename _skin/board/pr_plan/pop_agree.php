...
<div class="popupWrap">
	...
	<div class="popContWrap">
		<form name="SearchForm" method="get" action="<?=$PHP_SELF?>" onsubmit="return search_go()">
				...
				<table class="adm-searchForm">
					...
					<tbody>
						<tr>
							...
							<td>
								<select name="search">
									<option value="subject" <? if ($search == "subject" ) echo "selected"; ?>>보험약관명</option>
								</select>
			...
			<? if ($total_record == 0) { ?>
				<tr>
					<td colspan="3"><?=$GLOBALS[msg_list_notdata]?></td>
				</tr>
			<?
				} else {
