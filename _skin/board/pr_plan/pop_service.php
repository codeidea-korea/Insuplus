			...
			<table class="adm-searchForm">
				...
				<tbody>
					<tr>
						...
						<td>
							<select name="search">
								<option value="subject" <? if ($search == "subject" ) echo "selected"; ?>>서비스약관명</option>
							</select>
...
<script>
	...
	function g_select(idx,subject){
		...
		ff.service_cd.value=idx;
		$("#service_cd_txt",opener.document).text(subject);
		window.close();
	}
