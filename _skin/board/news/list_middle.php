...
//사용자 모드입니다
	if ($client_mode=="Y"){?>
		...
		?>
									<li><?=$view_link?>
											<em class="img"><?=$print_list_image?><!-- <img src="/images/board/test_img.jpg" alt="이지함 피부과" /> --></em>
											<strong style="width:195px;"><?=$subject?></strong>
											<!-- <span><?=$PrintRegDate?></span> --> <!-- <span class="bullTy05 mL10"><?=$view_cnt?></span> -->
										</a>
									</li>
		<? }elseif ($list_type == "list") { ?>
									<li><?=$view_link?>
											<em class="img"><?=$print_list_image?></em>
											<strong style="width:195px;"><?=$subject?></strong>
											<!-- <span><?=$PrintRegDate?></span> --> <!-- <span class="bullTy05 mL10"><?=$view_cnt?></span> -->
										</a>
									</li>
...
<?}else{?>
		...
		<? }elseif ($list_type == "list") { ?>
			<tr>
				...
				<td align="center" width="70"  class="b_subtitle"><?=$print_cate_name?></td>
				<? } ?>
				<td class="b_subtitle"><span class="list_img"><?=$print_list_image?></span> <?=$view_link?><?=$re?><?=$subject?> <?=$print_cmt_cnt?> <?=$print_secret?> <?=$sNew?> <?=$print_hidden?></a></td>
