...
?>
<form name="WriteForm" action="" method="post" enctype="multipart/form-data" onsubmit="return WriteGopOkGo()">
...
<table class="adm-view-tb">
	...
	<tr>
		<th>방문예정일</th>
		<td><input type="text" name="visit_date" class="datepicker w100" value="<?=$occur_date?>"></td>
		<th>병원명</th>
	...
	<tr>
		<th>해외네트워크</th>
		<td><input type="text" name="network" value="<?=$network;?>"></td>
		<th>GOP상태</th>
		<td><select name="gop_status" />
