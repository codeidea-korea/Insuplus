<style>
	...
	.speech-bubble:before {
		content: '';
		background-image: url("/html/images/img_Q.png");
	...
	.speech-bubble-A:before {
		content: '';
		background-image: url("/html/images/img_A.png");
		background-size: 60px 60px;
		width: 60px;
		height: 60px;
		position: absolute;
	...
	.speech-bubble-C:before {
		content: '';
		background-image: url("/html/images/img_line.png");
	...
	<div class="col-md-10 col-sm-9">
		<div class="sub-content cs-wrap">
			<div class='row-border responsive'>
				...
				<div class='detail-col-label valign-middle hidden-xs'>
					<p>내용&nbsp;<span class='text-danger'>*</span></p>
				</div>
	...
	<table class="adm-view-tb">
		...
		<tr>
			...
			<td colspan="3"><? if ($bc_notice_use == "Y" && $auth_notice) { ?>
					<input type="checkbox" disabled name="notice" value="Y" <? if ($notice == "Y") {
																				echo "checked";
																			} ?> />※ 공지글 인 경우 체크해 주세요.
				<? } ?>
			</td>
