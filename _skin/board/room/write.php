...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
	...
	<tr>
		<td class="b_txt_w">방이름</td>
		<td class="m_content">
			<input type="text" name="ext1" value="<?=$ext1?>" style="width:30%" maxlength="150" class="input"/>
		</td>
	</tr>
	<tr>
		<td colspan="2" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		<td class="b_txt_w">크기</td>
		<td class="m_content">
			<input type="text" name="ext3" value="<?=$ext3?>" style="width:50" maxlength="150" class="input"/>평
		</td>
	</tr>
	<tr>
		<td colspan="2" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		<td class="b_txt_w">기준인원</td>
		<td class="m_content">
			<input type="text" name="ext4" value="<?=$ext4?>" style="width:50" maxlength="150" class="input"/>명
		</td>
	</tr>
	<tr>
		<td colspan="2" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		<td class="b_txt_w">최대인원</td>
		<td class="m_content">
			<input type="text" name="ext5" value="<?=$ext5?>" style="width:50" maxlength="150" class="input"/>명
		</td>
	</tr>
	<tr>
		<td colspan="2" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		<td class="b_txt_w">1일 비수기요금</td>
		<td class="m_content">
			<span style="width:70px;">일~목</span> <input type="text" name="day_m1_1" value="<?=$day_m1_1?>" style="width:30%" maxlength="150" class="input"/>원<br/>
			<span style="width:70px;">금요일</span> <input type="text" name="day_m1_2" value="<?=$day_m1_2?>" style="width:30%" maxlength="150" class="input"/>원<br/>
			<span style="width:70px;">토,공휴일전날</span> <input type="text" name="day_m1_3" value="<?=$day_m1_3?>" style="width:30%" maxlength="150" class="input"/>원
		</td>
	</tr>
	<tr>
		<td colspan="2" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		<td class="b_txt_w">1일 준성수기요금</td>
		<td class="m_content">
			<span style="width:70px;">일~목</span> <input type="text" name="day_m2_1" value="<?=$day_m2_1?>" style="width:30%" maxlength="150" class="input"/>원<br/>
			<span style="width:70px;">금요일</span> <input type="text" name="day_m2_2" value="<?=$day_m2_2?>" style="width:30%" maxlength="150" class="input"/>원<br/>
			<span style="width:70px;">토,공휴일전날</span> <input type="text" name="day_m2_3" value="<?=$day_m2_3?>" style="width:30%" maxlength="150" class="input"/>원
		</td>
	</tr>
	<tr>
		<td colspan="2" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		<td class="b_txt_w">1일 성수기요금</td>
		<td class="m_content">
			<span style="width:70px;">일~목</span> <input type="text" name="day_m3_1" value="<?=$day_m3_1?>" style="width:30%" maxlength="150" class="input"/>원<br/>
			<span style="width:70px;">금요일</span> <input type="text" name="day_m3_2" value="<?=$day_m3_2?>" style="width:30%" maxlength="150" class="input"/>원<br/>
			<span style="width:70px;">토,공휴일전날</span> <input type="text" name="day_m3_3" value="<?=$day_m3_3?>" style="width:30%" maxlength="150" class="input"/>원
		</td>
	</tr>
	<tr>
		<td colspan="2" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		<td class="b_txt_w">서비스안내</td>
		<td class="m_content">
			<textarea name="ext10" id="ext10" style="width:100%;height:200px;" class="textarea"><?=$ext10?></textarea>
		</td>
	</tr>
	<tr>
		<td colspan="2" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		...
		<td class="m_content">
			...
			?><textarea name="content" id="conte명t" style="width:100%;height:300px;" class="textarea"><?=$content?></textarea><?
			}
			?>
		</td>
	</tr>
...
<?for ($k = 1 ; $k<13 ; $k++){?>
	<tr>
		<td class="b_txt_w">이미지<?=$k?></td>
		<td class="m_content">
			<input name="file<?=$k?>" type="file" size="20" class="input" />
			<?
				$filek = "file".$k;
				$filename = ${$filek};
				...
				if ( getLen(${$filek}) > 0 ) {
			?>
					<input type="checkbox" name="del_file<?=$k?>" value="<?=$filename?>">삭제
			<?
					$ar_filename = setFileName(${$filek});
			?>
					<a href="<?=$upload_url?>/<?=$ar_filename[0][1]?>" target="_blank"><img src="<?=$upload_url?>/<?=$ar_filename[0][1]?>.2thumb" width="50" height="50"></a>
			<?
				}
			?>
		</td>
