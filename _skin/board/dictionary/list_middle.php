...
//사용자 모드입니다
	if ($client_mode=="Y"){?>
		<?
			...
			if ($list_type == "notice") {
		?>
							<li class="list01"><a href="#"><?=$subject?></a>
								<div>
									<h4 class="titleTy01"><?=$subject?></h4>
									<ul>
										<li><?=$content?></li>
									</ul>
								</div>
		...
		<? }elseif ($list_type == "list") { ?>
							...
							?>
							<li class="list<?=$tnum?> <?=$active_css_txt?>"><a href="#"><?=$subject?> <?=$TempNo?></a>
								<div>
									<h4 class="titleTy01"><?=$subject?></h4>
									<ul>
										<li><?=$content?></li>
		...
		<? }elseif ($list_type == "null") { ?>
							<li class="list01 active"><a href="#">&nbsp;</a>
								<div>
