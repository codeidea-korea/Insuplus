						...
						<table border=0 cellspacing=0 cellpadding=10 width=100%>
							<tr>
								<td valign=top>
										...
										if ($bc_upfile_image == "Y") {
											...
											if ( getLen($$ObjFileName) > 0 ) {
												...
												for ( $i = 0 ; $i < count(${"Arr_".$ObjFileName}); $i++) {
													...
													echo "리스트 이미지<br/><a href=\"javascript:showPicture('".$upload_url."/".${"Arr_".$ObjFileName}[$i][1]."')\"><img src=\"".$upload_url."/".${"Arr_".$ObjFileName}[$i][1]."\" ".${"size".$ObjFileName}."></a>";
									...
									<table border=0 cellspacing=0 cellpadding=0 width=100%>
										<tr>
											<td class="b_content" valign=top style="padding:10px 10px 10px 10px"><?=nl2br($content)?></td>
										</tr>
									</table>
								</td>
							</tr>
