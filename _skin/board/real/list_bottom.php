...
//사용자 모드입니다
	if ($client_mode=="Y"){?>
						...
						<div class="paging">
							...
							<?}else{?>
							<div>
								<a href="javascript:alert('로그인을 해주시기 바랍니다.');document.location.href='<?=$root_dir?>/html/login/login.php?url=/html/community/post.php?mode=write';" class="boxTxt boxSt01">글쓰기</a>
							</div>
							<? } ?>
						</div>
						<!-- // 페이징 -->
