...
include $path_admin."inc/header_pop.php";
	...
	//쿠폰명
	$SQL = " SELECT coupon_name FROM tbl_board_event WHERE seq = '".$event_seq."' ";;
	$RS = $dbcon->query($SQL);
	...
	$search_orderby = "h.writedate";
	$search_sort = "DESC";
	// 쿼리설정
	$field			= " h.mobile, h.use_yn, h.writedate, h.start_date, h.end_date ";
	$field		   .= " ,h.orderno";
	...
	$table 		   .= " LEFT JOIN tbl_order_list_join j ";
	$table		   .= " ON h.orderno = j.orderno ";
