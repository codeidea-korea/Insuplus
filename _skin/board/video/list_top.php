					...
					<div class="board">
						<div class="title">
							...
							<div class="search">
								...
								<option value="" <? if ($search_ext == "all" || $search_category == "" ) echo "selected"; ?>>전체</option>
								<option value="video" <? if ($search_ext == "video") echo "selected"; ?>>비디오</option>
								<option value="flash" <? if ($search_ext == "flash") echo "selected"; ?>>애니메이션</option>
								</select>
						...
						<ul class="imgList05 blankAreaTy01">
