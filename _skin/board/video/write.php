...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
	...
	?>
	<tr>
		<td class="b_txt_w">동영상 파일명</td>
		<td class="m_content" style="letter-spacing:0px">
			http://www.ljh.co.kr/_data/<?=$bc_id?>/
			<input type="text" name="ext1" value="<?=$ext1?>" style="width:150px;" class="input">
			<br/> FTP를 통해서 /_data/<?=$bc_id?>/ 폴더에 파일을 넣으시고 파일명을 써주시면 됩니다. <font color="red">한글명은 안됩니다.</font>
		</td>
	</tr>
	<tr>
		<td colspan="2" class="m_line_1px">&nbsp;</td>
	...
	<tr>
		<td class="b_txt_w">동영상 종류</td>
		<td class="m_content" style="letter-spacing:0px">
			<input type="radio" name="ext2" value="flash" <?if ($ext2=="flash" || $ext2==""){?>checked<?}?>> 플래시(swf)
			<input type="radio" name="ext2" value="video" <?if ($ext2=="video"){?>checked<?}?>> 비디오파일(wmv,avi)
		</td>
	</tr>
	<tr>
		<td colspan="2" class="m_line_1px">&nbsp;</td>
