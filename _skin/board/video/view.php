						...
						<div class="boardView01">
							<table>
								...
								<tbody>
									...
									<tr>
										<td colspan="6" class="boardCont01">
											<div class="movieView">
												<div class="movie">
													<?if ($ext1){?>
															<?if ($ext2=="flash"){?>
																...
																<script type="text/javascript">
																 swfobject.embedSWF("/_data/<?=$bc_id?>/<?=$ext1?>", "swf_content", "350", "250", "11.1.102");
																 </script>
															<?}else if ($ext2=="video"){?>
																<script type="text/javascript">
																 on_vodmain("/_data/<?=$bc_id?>/<?=$ext1?>");
																 init("/_data/<?=$bc_id?>/<?=$ext1?>");
																 </script>
															<?}?>
														<?}?>
												</div>
						...
						<table border=0 cellspacing=0 cellpadding=10 width=100%>
							<tr>
								<td valign=top>
									...
									<table border=0 cellspacing=0 cellpadding=0 width=100%>
										<tr>
											<td class="b_content" valign=top style="padding:10px 10px 10px 10px">
												<?if ($ext1){?>
													<?if ($ext2=="flash"){?>
														<div id="swf_content" style="width:100%;text-align:center;"></div>
														<script type="text/javascript">
														 swfobject.embedSWF("/_data/<?=$bc_id?>/<?=$ext1?>", "swf_content", "350", "250", "11.1.102");
														 </script>
													<?}else if ($ext2=="video"){?>
...
<!--
function init(filesrc){
	if(filesrc!=null && filesrc!="" && filesrc!="null"){
		hiplayer.Filename = filesrc;
		playIt();
	}
}

function playIt(){
		if(hiplayer.Filename!=""){
			if ((navigator.userAgent.indexOf('IE') > -1) && (navigator.platform == "Win32")) {
				hiplayer.Play();
			}else{
				document.hiplayer.Play();
			}
//			play.src = "img/main/btn_play.gif";
//			pause.src = "img/main/btn_pause.gif";
//			stop.src = "img/main/btn_stop.gif";
		}
}
...
function pauseIt(){
		if(hiplayer.Filename!=""){
			if ((navigator.userAgent.indexOf('IE') > -1) && (navigator.platform == "Win32")) {
				if (hiplayer.PlayState == 2){
					hiplayer.Pause();
				}
			}else{
				if (document.hiplayer.GetPlayState() == 2){
					document.hiplayer.Pause();
				}
			}
			play.src = "img/main/btn_play.gif";
			pause.src = "img/main/btn_pause.gif";
...
function stopIt(){
		if(hiplayer.Filename!=""){
			if ((navigator.userAgent.indexOf('IE') > -1) && (navigator.platform == "Win32")) {
				hiplayer.Stop();
				hiplayer.currentPosition = 0;
			}else{
				document.hiplayer.Stop();
				document.hiplayer.CurrentPosition=0;
			}
			play.src = "img/main/btn_play.gif";
			pause.src = "img/main/btn_pause.gif";
			stop.src = "img/main/btn_stop.gif";
