...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
	...
	<tr>
		<td class="b_txt_w">대표글</td>
		<td class="m_content">
			<input type="checkbox" name="ext3" value="Y" <?if ($ext3=="Y"){?>checked<?}?>>
		</td>
	</tr>
	<tr>
...
?>
	...
	<tr>
		...
		<td class="m_content">
			...
			<select name="doctors" onchange="c_sel_doctor(this.value,this.form)">
				<option value="">:: 선택하세요 ::</option>
				<?for ($J=0;$J<sizeof($arr_doctor_name);$J++) {?>
				<option value="<?=$arr_doctor_id[$J]."@".$arr_doctor_name[$J]?>" <? if ($arr_doctor_id[$J] == $writer) echo "selected";?>><?=$arr_doctor_name[$J]?></option>
				<?}?>
			</select>
		</td>
	</tr>
	...
	<tr>
		<td class="b_txt_w">요약내용</td>
		<td class="m_content">
			<?$ext1 = REQSTR2($ext1);?>
			<input type="text" name="ext1" value="<?=$ext1?>" style="width:80%" class="input"/> 최대 250자
		</td>
	</tr>
	<tr>
		<td colspan="2" class="m_line_1px">&nbsp;</td>
