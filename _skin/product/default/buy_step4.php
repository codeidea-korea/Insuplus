...
<div id="cont">
	...
	<div id="title">
		<div id="subject">
			<!-- Title -->
			<script>flashView("/inc/swf/sub_title.swf?pro_tit=주문내역 확인",352,30);</script>
			<!-- End -->
		</div>
		<div id="sitemap"><!-- SiteMap --><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td>HOME > 구매정보 > <span class="point_txt01">주문내역 확인</span></td><td width="1"><?php	include $_SERVER["DOCUMENT_ROOT"]."/inc/php/quick.php";?></td></tr></table><!-- End --></div>
	</div>
	...
	<div id="con">
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				...
				<td class="board_list_style2" align="center"><?=$row2["pr_name"]?><BR><?=$row2["print_option"]?></td>
				<td bgcolor="#dbdbdb"></td>
		...
		<div style="text-align:center;">
			<a href="cart.php?mode=buy&step=end"><img src="/images/99_common/btn_ok.gif">  </a>
		</div>
		<br/>
		<br/>
