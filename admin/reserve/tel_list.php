...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		...
		<td valign="top" class="a_st">전화예약 문의</td>
	</tr>
	<tr>
  ...
  $("#ui-datepicker-div").hide(); //자동으로 생성되는 div객체 숨김
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="0">
				...
				<tr>
					...
					<td align="center" bgcolor="#F3F3F3" class="a_thead">지점</td>
			...
			?>
				<tr>
					...
					<td align="center" class="a_content_td"><?=$Arr_h_area2[$area]?></td>
					...
					<td align="center" class="a_content_td"><?=$r_time1?>:<?=$r_time2?></td>
					<td align="center" class="a_content_td">
						<select name="r_state" onchange="modify_go('<?=$idx?>',this.value)">
							<option value="예약대기" <?if ($r_state=="예약대기"){echo "selected";}?>>예약대기</option>
							<option value="예약완료" <?if ($r_state=="예약완료"){echo "selected";}?>>예약완료</option>
							<option value="답변완료" <?if ($r_state=="답변완료"){echo "selected";}?>>답변완료</option>
						</select>
					</td>
...
<iframe src="" width="0" height="0" name="ifr_act" id="ifr_act" style="display:none;"></iframe>
<script>
