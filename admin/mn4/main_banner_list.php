...
function popup_main_roll() {
	var popup_member = window.open('/_skin/board/main_banner/popup_main_roll.php','popup_main_roll','width=700,height=500, top=0, left=0');
}
</script>
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		...
		<td valign="top" class="a_st">메인 배너</td>
	</tr>
	<tr>
