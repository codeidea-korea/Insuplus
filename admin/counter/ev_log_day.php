...
// 검색
$search_col = "substr(regdate,1,10)";
$SQL = "select ".$search_col.",count(".$search_col.") as cnt from tbl_event_log where substr(regdate,1,10) between '".$s_date."' and '".$e_date."' and ev_code='".$ev_code."' group by substr(regdate,1,10) order by substr(regdate,1,10) asc limit 10 ";
//echo $SQL."<br/>";
$RS1 = $dbcon -> query($SQL);
?>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		...
		<td valign="top" class="a_st">이벤트 일자별 통계</td>
	</tr>
	<tr>
...
<iframe src="ev_chart_line.php?ev_log=1<?=$subquery?>" name="chart1" id="chart1" width="1050" height="300" frameborder="0" scrolling="no"></iframe>
