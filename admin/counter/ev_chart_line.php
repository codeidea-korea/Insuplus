...
$SQL = "select ".$search_col.",count(".$search_col.") as cnt from tbl_event_log where substr(regdate,1,10) between '".$s_date."' and '".$e_date."' and ev_code='".$ev_code."' group by substr(regdate,1,10) order by substr(regdate,1,10) asc ";
//echo $SQL."<br/>";
$RS = $dbcon -> query($SQL);
