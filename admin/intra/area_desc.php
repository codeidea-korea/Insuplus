...
if ( strlen($search_orderby) == 0 ) $search_orderby .= " idx desc, area_code ";
...
<table width="1100" cellspacing="0" cellpadding="0" border="0">
	<tr>
		<td>
			<a href="area_desc_write.php"><img src="/_skin/board/faq/images/b_btn_write.gif"></a>
			<table width="100%" cellspacing="0" cellpadding="0" border="0">
				...
				<tr>
					...
					<td align="center" bgcolor="#F3F3F3" class="a_thead" width="150">연락처</td>
					<td align="center" bgcolor="#F3F3F3" class="a_thead" width="180">진료시간</td>
					<td align="center" bgcolor="#F3F3F3" class="a_thead" width="">주소</td>
				...
				<tr>
					...
					<td align="center" class="a_content_td"><?=$a_tel?></td>
					<td align="center" class="a_content_td"><?=$a_time1?><br/><?=$a_time2?><br/><?=$a_time3?></td>
					<td align="center" class="a_content_td"><?=$addr_zip?><?if ($addr_load){?><br/><?=str_replace("<br/>","",$addr_load)?><?}?></td>
...
function modify_go(idx) {
	document.location.href="area_desc_write.php?idx="+idx;
}

function drop_go(idx) {
    MSG = "정말 삭제 하시겠습니까?\n삭제하면 기존 정보로 복원은 하실 수 없습니다.";
    if (confirm(MSG)) {
        location.href = "area_desc_del.php?idx="+idx+"<?=$parameter?>";
    }
}
</script>
<!-- ### 페이지 끝 ###  -->
