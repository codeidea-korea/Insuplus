...
<div id="wrapper">
	...
	<section id="main_top">
		<div class="sectionContainer">
			...
			<div class="flex-middle gap25 scrollMotion pc-only">
				...
				<a href="https://insuplus.co.kr/html/insurance/renewal_step00.php" target="_blank" alt="간편 가격조회 하기"><img src="./img/main_top_btn02.png"></a>
			</div>
		</div>
	</section>
	...
	<div id="main">
		...
		<div id="_quick_pannel" class="pc-only">
			<div id="_quick">
				...
				<a href="https://insuplus.co.kr/html/insurance/renewal_step00.php" target="_blank" alt="간편 가격조회 하기"><img src="./img/quick02.png" class="scrollMotion right"></a>
	...
	<div id="_mobile_floating_btn" class="mobile-only">
		...
		<a href="https://insuplus.co.kr/html/insurance/renewal_step00.php" target="_blank" alt="간편 가격조회 하기"><img src="./img/mobile_floating_btn02.png"></a>
	</div>
</div>
