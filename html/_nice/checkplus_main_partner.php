...
$_SESSION["ALLIANCE_CODE"] = $alliance_code;
...
$returnurl = $url."/html/insurance/partner_step01.php?nice_return=1";
$errorurl = $url . "/html/insurance/partner_step01.php?nice_return=1";        // 실패시 이동될 URL
