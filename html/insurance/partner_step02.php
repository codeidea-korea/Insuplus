        ...
        <div class="container">
          ...
          <div class="white-box middle mt24 type01">
            ...
            <div class="caution-box mt12" style="display: none;">
              ...
              <h6>08. 예금자 보호 안내</h6>
              <p>이 보험계약은 예금자보호법에 따라 예금보험공사가 보호하되, 보호 한도는 본 보험회사에 있는 귀하의 모든 예금보호 대상 금융상품의 해약환급금(또는 만기 시 보험금이나 사고보험금)에 기타지급금을 합하여 1인당 "최고 1억만 원"이며, 1억만 원을 초과하는 나머지 금액은 보호하지 않습니다. 다만, 보험계약자 및 상품가격 납부자가 법인이면 보호되지 않습니다. 위 내용은 예금자보호법 및 관련 법령의 개정에 따라 달라질 수 있으며, 자세한 내용은 <a href="www.kdic.or.kr" target="_blank">예금보험공사(www.kdic.or.kr)</a>로 문의하시기 바랍니다.</p><br/>
    ...
    <script>
      ...
      window.addEventListener('load', (e) => {
        ...
        document.querySelector('button.write').addEventListener('click', (e) => {
          ...
          EHDObject.save();
          location.href = './partner_step03.php';
        });
