...
$SQL1 .= " , join_ch = '".$_SESSION["ss_partner_seq"]."' ";
...
//	$arr_pr_notice_a[]	= $_POST["notice_a"][$k];
	...
	$SQL_N .= " ,pr_notice_a = '".$_POST["pr_notice_a"][$k]."' ";
//	echo $SQL_N."<br>";
...
<!--<input type="text" name="P_NEXT_URL" 	id="textfield9"		value="https://mobile.inicis.com/smart/testmall/next_url_test.php"  /> 결과페이지 링크 -->
<!-- <input type="text" name="P_NEXT_URL" value="https://mobile.inicis.com/smart/testmall/next_url_test.php" id="textfield9" /> --><!-- 결과페이지 링크 -->
...
<input type="hidden" name="P_RETURN_URL" 					value="<?=$domain.$add_port?>/html/insurance/register_result.php" />
