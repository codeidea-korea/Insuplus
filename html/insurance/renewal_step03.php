        ...
        <div class="container">
                ...
                <div class="form-content">
                  ...
                  <div class="form-border">
                    <div class="form-question">
                      <div class="flex flex-vc flex-tj">
                        <p>개인정보수집 및 이용 동의</p>
                        <a href="javascript:;" onclick="popupOpenRule('개인정보 수집 및 이용 동의');">자세히 보기</a>
                      </div>
                    </div>
                    <div class="flex flex-vc px24 px-lg-20">
                      <div class="check-box mr50 mr-lg-25" data-group="check02">
          ...
          <div class="white-box middle mt24 type01">
            ...
            <div class="caution-box mt12" style="display: none;">
              <h6>01. 보험계약체결</h6>
              <p>보험계약 체결 전에 상품설명서 및 약관을 읽어보시기 바랍니다. 보험계약자가 기존에 체결했던 보험계약을 해지하고 다른 보험계약을 체결하면 보험인수가 거절되거나 상품가격이 인상되거나 보장내용이 달라질 수 있습니다.</p>
              ...
              <p>발생 의료비 중 국민건강보험 급여의 본인부담금과 비급여를 보장해주는 보험이며, 약관상 보장제외 항목에서 발생한 의료비는 보장되지 않습니다. 실제 발생한 의료비를 보상하는 보험을 2개 이상 가입하더라도 실제 발생한 비용만을 보상받게 되므로, 유사한 보험가입여부 및 보상한도를 반드시 확인하시기 바랍니다. 보험금을 지급할 다수의 보험계약이 체결되어 있는 경우에는 각각의 계약에 대하여 다른 계약이 없는 것으로 하여 산출한 보상책임액의 합계액이 이 계약의 의료비를 초과했을 때, 이 계약에 따른 보상책임액의 위의 합계액에 대한 비율에 따라 의료비보험금을 지급하여 드립니다.</p>
              <h6>04. 청약철회 청구제도</h6>
              <p>계약자는 보험증권을 받은 날로부터 15일 이내에 그 계약의 청약을 철회할 수 있으며 이 경우 이미 납입한 상품가격을 돌려드립니다. 다만, 진단계약, 보험기간이 1년 미만인 계약인 계약 또는 전문금융소비자가 체결한 계약의 경우에는 청약을 철회할 수 없으며 청약을 한 날로부터 30일이 초과된 계약은 청약을 철회할 수 없습니다.</p>
              <h6>05. 보험계약상의 알릴 의무</h6>
              <p>보험계약 청약 시 계약자 및 피보험자는 청약서상의 질문사항(고지사항)에 대하여 사실대로 알려야 합니다. 만일 허위 또는 부실하게 알렸을 경우에는 보험사고 발생 시 보상이 되지 않음은 물론 보험계약이 해지될 수 있습니다.</p>
              ...
              <p>보험사가 3대 기본 지키기 미이행 시 보험계약자는 계약이 성립한 날로부터 3개월 이내에 계약을 취소할 수 있습니다. 이 경우 회사는 이미 납입한 상품가격을 돌려 드립니다.</p>
              <h6>07. 해지환급금 산출기준</h6>
              <p>계약자, 피보험자 또는 보험수익자의 책임없는 사유에 의하는 경우 : 무효의 경우에는 회사에 납입한 상품가격의 전액, 효력상실, 해지 또는 소멸의 경우에는 경과하지 않은 기간에 대하여 일 단위로 계산한 상품가격</p>
              <p>계약자, 피보험자 또는 보험수익자의 책임있는 사유에 의하는 경우 : 이미 경과한 기간에 대하여 단기요율(1년 미만의 기간에 적용되는 요율)로 계산한 상품가격을 뺀 잔액. 다만, 계약자, 피보험자 또는 보험수익자의 고의 또는 중대한 과실로 무효가 된 때에는 상품가격을 돌려드리지 않습니다.</p>
              <h6>08. 예금자 보호 안내</h6>
              ...
              <p>보험에 대한 문의사항 및 불만사항이 있을 경우 한화손해보험(1566-8000), 메리츠화재(1566-7711)으로 연락주시면 신속하게 처리해 드리겠습니다. 또한 보험에 관한 분쟁이 있을 때에는 금융감독원 및 한국소비자원에 분쟁조정을 신청할 수 있습니다.</p>
              ...
              <p>한국소비자원 전화 : 1372 / 인터넷 : <a href="www.kca.go.kr" target="_blank">www.kca.go.kr</a></p>
              <h6>10. 청약철회제도</h6>
