...
require_once("./dompdf/dompdf_config.inc.php");
		...
		if($row_r["chk_service"] != "N" && $row_r["chk_service"] != "" && $chk_type == "A") {
			...
			if($chk_lang!="E"){
				...
				$CHK_TABLE_EN = "<table width='100%' cellspacing='0' cellpadding='0' border='0' style='border-top: solid 2px #595959;border-bottom: solid 2px #595959; margin:0 0 14px 0;'>
									...
									<th style=\"background-color: #f6f6f6;padding:5px 15px;font-size:13px;font-weight:400;text-align:center;border-bottom:2px solid #595959;\">Coverage Limit</th>
									</tr></thead><tbody>";
		...
		if ($G_LIST){
			if($chk_lang!="E"){
				...
				<th style='background-color: #f6f6f6;padding:5px 15px;font-size:13px;font-weight:400;text-align:center;border-bottom:2px solid #595959;'>보험가입금액 / 보상한도액</th>
				</tr></thead><tbody>";
			}
