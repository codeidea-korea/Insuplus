						...
						<div class='row-border row-sm'>
							...
							<div class='detail-col-input'>
								<div class='input-group' style='width:100%;'>
									...
									<input type="tel" name='rnumber' placeholder="주민등록번호를 확인해주세요." autocomplete="off" class="form-control numberonly" size='12' maxlength="7" onkeypress="if(event.keyCode==13) chk_submit();" />
								</div>
							</div>
						</div>
						<div class='row m-t-2'>
