		...
		<div class="breadcrumb-wrap">
            <div class="container">
				<ol class="breadcrumb">
					...
					<li><a href="../service/reward_list.php">보상서비스</a></li>
					<li>보상사례</li>
				</ol>
            </div>
        </div>
			...
			<div class="container">
				<div class="row">
					...
					<?
						...
						$bc_id = "compensation_case";									// 생성된 게시판 ID 실제로 테이블은 tbl_board_notice
...
function frontList() { //리스트 페이지 이동
	location.href = "reward_list.php?mode=list&page=<?=$page?><?=$parameter?>";
}
...
function frontViewGO(seq) {	
	location.href = "reward_list.php?mode=view&seq="+seq+"&page=<?=$page?><?=$parameter?>";
}
